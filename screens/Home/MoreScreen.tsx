...
import {
    Dimensions, Image, ScrollView, Text, TouchableOpacity, View
} from 'react-native'
...
const MoreScreen = (props) => {
  return (
    <ScrollView>
      ...
      >
        <Image
          source={require('../../assets/gamenight.jpeg')}
          style={{
            height: 259,
            width: width - 12,
            borderRadius: 15,
        ...
        >
          <View style={{ flexDirection: 'row' }}>
            ...
            >
              ...
              <Text
                style={{ fontFamily: styleconstants.primaryFont, fontSize: 13 }}
              >
                Meet, share or trade with BGG users nearby.
              </Text>
            </View>
      ...
      >
        <Image
          source={require('../../assets/prev.jpg')}
          style={{
            height: 250,
            width: width - 12,
            margin: 6,
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            >
              ...
              <Text
                style={{ fontFamily: styleconstants.primaryFont, fontSize: 13 }}
              >
                Find the latest board and card game releases.
              </Text>
            </View>
